...
COMPILER_C_AECF_PARSER := $(COMPILER_C_FRONTEND_DIR)/aecf_parser.c
...
COMPILER_C_AARCH64_ENCODER := $(COMPILER_C_MIDDLEEND_DIR)/aarch64_encoder.c
...
COMPILER_C_FORMAT_EXE_WEAVER := $(COMPILER_C_FORMATS_DIR)/exe/exe_binary_weaver_impl.c
COMPILER_C_FORMAT_EXE_CODEGEN := $(COMPILER_C_FORMATS_DIR)/exe/exe_codegen_win64_impl.c
COMPILER_C_FORMAT_EXE_PORTAL := $(COMPILER_C_FORMATS_DIR)/exe/portal/exe_native_portal_impl.c
COMPILER_C_FORMAT_EXE_GUI := $(COMPILER_C_FORMATS_DIR)/exe/gui/exe_gui_subsystem_impl.c
COMPILER_C_FORMAT_WSYS := $(COMPILER_C_FORMATS_DIR)/wsys/wsys_gen.c
COMPILER_C_FORMAT_ROM := $(COMPILER_C_FORMATS_DIR)/rom/rom_gen.c
COMPILER_C_FORMAT_MACHO := $(COMPILER_C_FORMATS_DIR)/macho/macho_weaver.c
COMPILER_C_FORMAT_DER := $(COMPILER_C_FORMATS_DIR)/im4p/der_encoder.c
COMPILER_C_FORMAT_IM4P := $(COMPILER_C_FORMATS_DIR)/im4p/im4p_generator.c
...
COMPILER_C_SRCS := $(COMPILER_C_MAIN) $(COMPILER_C_AETHELC) \
	...
	$(COMPILER_C_PREPROCESS) $(COMPILER_C_SEMANTIC) $(COMPILER_C_PARSER) $(COMPILER_C_SILICON_SEM) $(COMPILER_C_IMPORT_RESOLVER) $(COMPILER_C_AECF_PARSER) \
	...
	$(COMPILER_C_HARDWARE_CODEGEN) $(COMPILER_C_X86_ENCODER) $(COMPILER_C_AARCH64_ENCODER) \
	...
	$(COMPILER_C_FORMAT_EXE_WEAVER) $(COMPILER_C_FORMAT_EXE_CODEGEN) $(COMPILER_C_FORMAT_EXE_PORTAL) $(COMPILER_C_FORMAT_EXE_GUI) \
	$(COMPILER_C_FORMAT_ROM) $(COMPILER_C_FORMAT_WSYS) $(COMPILER_C_FORMAT_MACHO) $(COMPILER_C_FORMAT_DER) $(COMPILER_C_FORMAT_IM4P)
...
$(OUTPUT_DIR)/core/toolsC/compiler/%$(OBJ_EXT): $(ROOT)/core/toolsC/compiler/%.c
	...
	$(NATIVE_CC) -c $(NATIVE_CFLAGS) \
		...
		-I$(COMPILER_C_FORMATS_DIR)/exe \
		-I$(COMPILER_C_FORMATS_DIR)/exe/codegen \
		-I$(COMPILER_C_FORMATS_DIR)/exe/portal \
		-I$(COMPILER_C_FORMATS_DIR)/exe/gui \
		-I$(COMPILER_C_FORMATS_DIR)/let \
		-I$(COMPILER_C_FORMATS_DIR)/wsys \
		-I$(COMPILER_C_FORMATS_DIR)/rom \
		-I$(COMPILER_C_FORMATS_DIR)/macho \
		-I$(COMPILER_C_FORMATS_DIR)/im4p \
